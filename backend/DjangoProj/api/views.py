...
from .models import Tender, Vacancy, StaffMember
from .serializers import TenderSerializer, VacancySerializer, StaffMemberSerializer, JobApplicationSerializer
